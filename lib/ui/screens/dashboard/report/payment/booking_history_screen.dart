...
import '../../../../../core/connect_end/model/get_all_booking_history/booking.dart';
...
class BookingHistoryScreen extends StatelessWidget {
  BookingHistoryScreen({super.key, required this.id, required this.name});
  String? id;
  String? name;
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ReportViewModel>.reactive(
        ...
        onViewModelReady: (model) {
          model.allBookingHistory(context, id!);
        },
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                TextView(
                                  text:
                                      '${getCurrency()}${oCcy.format(model.allBookingResponseModel?.data?.grossTotalDue ?? 0)}',
                            ...
                            Column(
                              children: [
                                ...
                                TextView(
                                  text:
                                      '${getCurrency()}${oCcy.format(model.allBookingResponseModel?.data?.totalAmountReceived ?? 0)}',
                                  fontWeight: FontWeight.w800,
                                  fontSize: 13.2.sp,
                                  color: AppColor.white,
                                )
                            ...
                            Column(
                              children: [
                                ...
                                TextView(
                                  text:
                                      '${getCurrency()}${oCcy.format(model.allBookingResponseModel?.data?.balanceNet ?? 0)}',
                                  fontWeight: FontWeight.w800,
                                  fontSize: 13.2.sp,
                                  color: AppColor.white,
                                )
                  ...
                  else if (model.allBookingResponseModel != null &&
                      model.allBookingResponseModel!.data!.bookings!.isNotEmpty)
                    ...model.allBookingResponseModel!.data!.bookings!
